...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onClickPrevButton = function () {
    if (_this2.isEmptyArray(_this2.props.images)) {
      return;
    }
    ...
    var nextIndex = _this2.state.index - 1;
    _this2.updatePageState(nextIndex);
  };

  this.onClickNextButton = function () {
    if (!_this2.props.images) {
      return;
    }
  ...
  this.onClickProgressBar = function (e) {
    ...
    var nextIndex = _this2.calcProgressIndex(barWidth, progressWidth);
    _this2.updatePageState(nextIndex);
  };
  ...
  this.onChangeFullScreen = function () {
    ...
    (0, _toggleFullscreen2.default)(element).then(function () {
      return (0, _toggleFullscreen.fullscreenChange)(function () {
        ...
        if (isFullScreen) {
          document.addEventListener('keydown', _this2.keydownEvent);
          element.style.width = '70%';
        } else {
          document.removeEventListener('keydown', _this2.keydownEvent);
  ...
  this.calcProgressIndex = function (barWidth, progressWidth) {
    ...
    var nextIndex = 0;
    for (var i = 0; i < _this2.props.images.length; i++) {
      var checkWidth = _this2.calcProgress(i);
  ...
  this.calcProgress = function (page) {
    var base = 100 / _this2.props.images.length;
  ...
  this.updatePageState = function (index) {
    var progress = _this2.calcProgress(index + 1);
    var image = _this2.props.images[index];
    _this2.setState({
      src: image,
      index: index,
      progress: progress
    });
    _this2.props.pageWillUpdate(index, image);
  };
  ...
  this._renderImages = function () {
    return _react2.default.createElement(
      'div',
      null,
      _this2.props.images.map(function (img, index) {
        var styleObj = _this2.state.index === index ? _Styles.Styles.SHOW_IMG : _Styles.Styles.HIDE_IMG;
        styleObj['width'] = '100%';
  ...
  this._renderPreview = function () {
    if (!_this2.props.images || _this2.props.images.length === 0) {
      return null;
    }

    var preview = _this2.props.images.map(function (img, index) {
      var display = index === _this2.state.previewIndex ? 'inline' : 'none';
    ...
    var bottom = _this2.state.isFullScreen ? fullscreenBottom : _Styles.Styles.PREVIEW.bottom;
    var STYLE = _extends({}, _Styles.Styles.PREVIEW, {
      opacity: _this2.state.preview,
      bottom: bottom
    });
    return _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        ...
        _this2.state.previewIndex + 1 + ' / ' + _this2.props.images.length
      )
    );
  };
