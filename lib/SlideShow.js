...
var SlideShow = function (_React$Component) {
  ...
  _createClass(SlideShow, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.updatePageIndex(function (index) {
        return _this2.updatePageState(index);
      });
    ...
    key: 'handleKeyDown',
    value: function handleKeyDown(isRemove) {
      if (isRemove) {
        document.removeEventListener('keydown', this.keydownEvent);
      } else {
        document.addEventListener('keydown', this.keydownEvent);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'slideshow-wrapper', style: _Styles.Styles.SLIDESHOW_WRAPPER },
          _react2.default.createElement(
            'div',
            {
              className: 'slideshow-wrapper-inner',
              style: _Styles.Styles.SLIDESHOW_WRAPPER_INNER
            },
            _react2.default.createElement(
              'div',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onClickPrevButton = function () {
    if (_this3.isEmptyArray(_this3.props.images)) {
      return;
    }

    if (_this3.state.index === 0) {
      return;
    }

    var nextIndex = _this3.state.index - 1;
    _this3.updatePageState(nextIndex);
  };

  this.onClickNextButton = function () {
    if (!_this3.props.images) {
      return;
    }

    if (_this3.state.index === _this3.props.images.length - 1) {
      return;
    }
    var nextIndex = _this3.state.index + 1;
    _this3.updatePageState(nextIndex);
  ...
  this.onMouseLeaveProgressBar = function (e) {
    _this3.setState({
      preview: 0
    });
  };
  ...
  this.onChangeFullScreen = function () {
    ...
    (0, _toggleFullscreen2.default)(element).then(function () {
      return (0, _toggleFullscreen.fullscreenChange)(function () {
        ...
        _this3.setState({ isFullScreen: isFullScreen });
        if (isFullScreen) {
          // document.addEventListener('keydown', this.keydownEvent);
  ...
  this.keydownEvent = function (e) {
    ...
    if (e.key === 'ArrowUp' || e.key === 'ArrowLeft' || e.keyCode === 37 || e.keyCode === 38) {
      _this3.onClickPrevButton();
    } else if (e.key === 'ArrowDown' || e.key === 'ArrowRight' || e.keyCode === 39 || e.keyCode === 40 || e.keyCode === 32) {
      _this3.onClickNextButton();
    } else if (e.key === 'Escape' || e.keyCode === 27) {
      _this3.onChangeFullScreen();
    }
  };

  this.calcProgressIndex = function (barWidth, progressWidth) {
    var clickPosition = Math.floor(progressWidth / barWidth * 100);
    var nextIndex = 0;
    for (var i = 0; i < _this3.props.images.length; i++) {
      var checkWidth = _this3.calcProgress(i);
  ...
  this.calcProgress = function (page) {
    var base = 100 / _this3.props.images.length;
  ...
  this.updatePageState = function (index) {
    var progress = _this3.calcProgress(index + 1);
    var image = _this3.props.images[index];
    _this3.setState({
      src: image,
      index: index,
      progress: progress
    });
    _this3.props.pageWillUpdate(index, image);
  };

  this._renderImages = function () {
    return _react2.default.createElement(
      'div',
      { className: 'image-parent', style: _Styles.Styles.IMAGE_PARENT },
      _this3.props.images.map(function (img, index) {
        var styleObj = _this3.state.index === index ? _Styles.Styles.SHOW_IMG : _Styles.Styles.HIDE_IMG;
        styleObj['width'] = '100%';
  ...
  this._renderPreview = function () {
    if (!_this3.props.images || _this3.props.images.length === 0) {
      return null;
    }

    var preview = _this3.props.images.map(function (img, index) {
      var display = index === _this3.state.previewIndex ? 'inline' : 'none';
    ...
    var bottom = _this3.state.isFullScreen ? fullscreenBottom : _Styles.Styles.PREVIEW.bottom;
    var STYLE = _extends({}, _Styles.Styles.PREVIEW, {
      opacity: _this3.state.preview,
      bottom: bottom
    });
    return _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        ...
        _this3.state.previewIndex + 1 + ' / ' + _this3.props.images.length
      )
    );
  };

  this._renderFullscreenIcon = function () {
    if (_this3.state.isFullScreen) {
      return _react2.default.createElement(
        'svg',
