  ...
  this.onChangeFullScreen = function () {
    ...
    (0, _toggleFullscreen2.default)(element).then(function () {
      return (0, _toggleFullscreen.fullscreenChange)(function () {
        ...
        if (isFullScreen) {
          document.addEventListener('keydown', _this3.keydownEvent);
          element.style.width = '70%';
        } else {
          document.removeEventListener('keydown', _this3.keydownEvent);
  ...
  this._renderImages = function () {
    return _react2.default.createElement(
      ...
      _this3.props.images.map(function (img, index) {
        ...
        styleObj['width'] = '100%';
        return _react2.default.createElement('img', { className: 'content', src: img, style: styleObj });
      })
    );
  };
